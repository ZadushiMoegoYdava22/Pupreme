                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="contactinfo">
                            ...
                            <li><a href="#"><i class="fa fa-envelope"></i> zadishi_moego_ydava@mail.ru</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="logo pull-left">
                            <a href="<?= \yii\helpers\Url::home()?>"><?= Html::img('@web/images/home/logo.png', ['alt' => 'PUPREME'])?></a>
                        </div>
                        ...
                        <div class="shop-menu pull-right">
                            <ul class="nav navbar-nav">
                                ...
                                <li><a href="#" onclick="return getCart()"><i class="fa fa-shopping-cart"></i> Корзина </a></li>
                                 <li><a href="<?= \yii\helpers\Url::to(['/admin'])?>"><i class="fa fa-lock"></i> Справочники </a></li>
                            </ul>
                        </div>
                    </div>
                </div>
...
<footer id="footer"><!--Footer-->
            ...
            <div class="row">
                <div class="col-sm-2">
                    <div class="single-widget">
                        ...
                        <ul class="nav nav-pills nav-stacked">
                            <li><a href="#">Онлайн заказ товаров</a></li>
                            <li><a href="#">Отправка письма на почту</a></li>
                ...
                <div class="col-sm-2">
                    <div class="single-widget">
                        <h2>О магазине</h2>
                        <ul class="nav nav-pills nav-stacked">
                            <li><a href="#">Компания основана в 2002 году</a></li>
                            <li><a href="#">Вакансий нет</a></li>
                            <li><a href="#">Берем цены из головы</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-sm-3 col-sm-offset-1">
                    <div class="single-widget">
                        ...
                        <form action="#" class="searchform">
                            ...
                            <p>Отправьте письмо <br /> для получения предложений и акций</p>
                        </form>
                    </div>
                </div>
    ...
    <div class="footer-bottom">
        <div class="container">
            <div class="row">
                <p class="pull-left"> Не тырьте пожалуйста шаблон ٩(๑`^´๑)۶ © 2002 Pupreme Inc.</p>
                <p class="pull-right">Дизайном занимался <span><a target="_blank" href="http://www.themeum.com">@zadushi_moego_ydava</a></span></p>
            </div>
        </div>
    </div>
